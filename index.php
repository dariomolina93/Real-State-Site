 ...
 -->				        <!-- Carousel indicators -->
				        ...
				        <!-- <div class="carousel-inner">
				            ...
				            <div class="carousel-item">
				                <img class="slider-context-size" src="https://images.buildzoom.com/api/file/R1YcJVyVQWKUPDeA7hLL/convert?h=1000&w=&strip=true&fit=crop&quality=65&cache=true&compress=true" alt="Second Slide">
				            </div>
				            <div class="carousel-item">
		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-5">
					...
					<p>Whether you're a first time home a buyer or looking for your vacation home, Tina will help you find the home of your dreams with the best deal and inform you of properties before they're listed on Redfin!</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-5">
					<i class="ti-money"></i>
					<h4 class="mb-3">Selling Your Home.</h4>
					<p>Want to know how much your home is worth? Wondering if it's a good time to sell? With Tina's expertise your home is guaranteed the best deal with multiple offers.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-5">
					<i class="ti-user"></i>
					<h4 class="mb-3">Real State Consulting.</h4>
					<p> With Tina's extensive knowledge about the local market, underwriting and realtor, you will have the best deals and guaranteed satisfaction.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-5 mb-lg-0">
					<i class="ti-vector"></i>
					<h4 class="mb-3">Finding the right Lender</h4>
					<p>Tina knows the best lenders who can give you the best rates.  With a team mindset, just like Tina you can rest assure your lender will look out for you every step of the way.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-5 mb-lg-0">
					<i class="ti-plus"></i>
					<h4 class="mb-3">Explore New Communities</h4>
					<p>Tina has extensive knowledge in the bay area, with expertise in Antioch, Brentwood, Oakley and Discovery Bay!</p>
				</div>
			</div>
...
<!-- 		<div class="testimonial-index-wrap" style="background-color: white; margin-top:27px;">
			<div class="testimonial-item position-relative">
				

				<div class="testimonial-item-content" >
					<img src="images/trulia.png" alt="" class="img-fluid rounded">
				</div>
			</div>
			<div class="testimonial-item position-relative">

				<div class="testimonial-item-content" >
					<img  src="images/google.jpeg" alt="" class="img-fluid rounded">
				</div>
			</div>
			...
			<div class="testimonial-item position-relative">
				...
				<div class="testimonial-item-content" >
					<img src="images/yelp.png" alt="" class="img-fluid rounded">
				</div>
			</div>
			<div class="testimonial-item position-relative" >

				<div class="testimonial-item-content">
					<img src="images/realtor.png" alt="" class="img-fluid rounded">
				</div>
			</div>
			<div class="testimonial-item position-relative" >

				<div class="testimonial-item-content">
					<img  src="images/zillow.png" alt="" class="img-fluid rounded">
				</div>
			</div>
		</div> -->
...
<section class="section latest-blog bg-2">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<span class="h6 text-color">Social Media</span>
	...
	<div class="cta-block-2 bg-gray p-5 rounded border-1">
		<div class="row justify-content-center align-items-center ">
			<div class="col-lg-7">
				...
				<h2 class="mt-2 mb-4 mb-lg-0">Buying or selling your home can be stressful, but with Tina's expertise, dedication, and commitment you're guaranteed the best deal</h2>
			</div>
			<div class="col-lg-4">
